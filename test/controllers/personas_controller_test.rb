...
class PersonasControllerTest < ActionController::TestCase
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post :create, persona: { arcana: @persona.arcana, base_level: @persona.base_level, name: @persona.name }
    end
  ...
  test "should update persona" do
    patch :update, id: @persona, persona: { arcana: @persona.arcana, base_level: @persona.base_level, name: @persona.name }
    assert_redirected_to persona_path(assigns(:persona))
  end
